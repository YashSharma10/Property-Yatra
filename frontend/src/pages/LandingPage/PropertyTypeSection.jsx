...
const PropertyTypeSection = () => {
  ...
  const handlePropertyTypeSearch = async (target) => {
    ...
    dispatch(setFilters({ propertyType: target }));
  };

  return (
    <section className="width mt-[400px]">
      {/* Section Title */}
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute top-5 left-5 backdrop-blur-md bg-white/80 p-2 rounded-md">
                    <h2 className="text-sm sm:text-lg md:text-xl font-medium text-slate-700 capitalize">
                      {prop.alt}
                    </h2>
