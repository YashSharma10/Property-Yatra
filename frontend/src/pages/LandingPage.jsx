...
import { authStatus } from "../utils/checkAuthenication.js";
const LandingPage = () => {
  console.log(authStatus);
  
  return (
    <div className="relative bg-gray-100 mx-auto max-w-7xl ">
      {/* Hero Section */}
      <section
        className="flex flex-col items-center justify-center bg-cover bg-center py-32 relative h-2/3"
        style={{
          backgroundImage:
      ...
      >
        ...
        {/* Added backdrop-blur-lg for glass effect */}
        <div className="z-10 text-center text-white">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 shadow-md">
            Find Your Dream Home
          </h1>
          <div className="text-xl mb-8">Rent, Buy, or Sell Properties</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="p-6 bg-white shadow-lg rounded-lg transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-600">
                Easily search, filter, and find the perfect property with our
                intuitive design.
              </p>
            </div>
            <div className="p-6 bg-white shadow-lg rounded-lg transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-600">
                Browse through thousands of properties for sale, rent, and more.
              </p>
            </div>
            <div className="p-6 bg-white shadow-lg rounded-lg transition-transform duration-300 hover:scale-105">
              <h3 className="text-xl font-semibold mb-4">
